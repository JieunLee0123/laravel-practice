...
<div class="bg-white w-full shadow rounded-lg mt-3 p-6 cursor-pointer">
    <div class="md:flex items-center">
        <div class="w-[20%] bg-yellow-50 rounded flex flex-shrink-0 items-center justify-center">
            <img src="https://image.tmdb.org/t/p/w500/{{ $movieData['poster_path'] }}" alt="hexa-logo" tabindex="0" class="focus:outline-none w-full h-full" />
        </div>
        <div class="md:ml-6 md:mt-0 mt-4 w-full">
            <div class="flex items-center justify-between">
                <p tabindex="0" class="focus:outline-none text-xl font-semibold leading-5 text-gray-800">{{ $movieData['title'] }}</p>
                <p tabindex="0" class="focus:outline-none text-xs leading-3 text-indigo-700 px-4 py-2 bg-indigo-100 rounded-full">{{ $tag }}</p>
            </div>
            <p tabindex="0" class="focus:outline-none text-sm pt-5 text-gray-600 ellipsis">{{ $movieData['overview'] }}</p>
